...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        req_df=spacex_df[spacex_df['Launch Site']==entered_site]
        print(req_df['class'])
        fig = px.pie(req_df, color='class', 
        names='class', 
...
def get_scatter_plot(entered_site):
    if entered_site == 'ALL':
        ...
        title='corelation betweeen payload and success',color="Booster Version Category")
        return fig
    else:
        # return the outcomes piechart for a selected site
